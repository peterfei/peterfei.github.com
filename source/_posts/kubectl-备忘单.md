...
## 更新资源[ ](https://kubernetes.io/zh/docs/reference/kubectl/cheatsheet/#更新资源)
...
## 部分更新资源[ ](https://kubernetes.io/zh/docs/reference/kubectl/cheatsheet/#部分更新资源)
...
## 编辑资源[ ](https://kubernetes.io/zh/docs/reference/kubectl/cheatsheet/#编辑资源)
...
## 删除资源[ ](https://kubernetes.io/zh/docs/reference/kubectl/cheatsheet/#删除资源)
...
### 格式化输出[ ](https://kubernetes.io/zh/docs/reference/kubectl/cheatsheet/#格式化输出)
...
### Kubectl 日志输出详细程度和调试[ ](https://kubernetes.io/zh/docs/reference/kubectl/cheatsheet/#kubectl-日志输出详细程度和调试)
